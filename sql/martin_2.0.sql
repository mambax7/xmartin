...
#--
#-- Host: 127.0.0.1
#-- Generation Time: Dec 30, 2015 at 06:59 AM
...
CREATE TABLE IF NOT EXISTS `martin_auction` (
  ...
  `check_out_date`         INT(11) UNSIGNED          DEFAULT '0',
  `apply_start_date`       INT(11) UNSIGNED          DEFAULT '0',
  `apply_end_date`         INT(11) UNSIGNED          DEFAULT '0',
  ...
  `auction_can_use_coupon` TINYINT(1) UNSIGNED       DEFAULT '0',
  `auction_sented_coupon`  DECIMAL(10, 2)            DEFAULT '0.00',
  `auction_status`         TINYINT(1)                DEFAULT '0',
  `auction_add_time`       INT(11) UNSIGNED          DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `martin_hotel` (
  ...
  COMMENT '酒店所属城市',
  `hotel_city_id`        VARCHAR(255)     DEFAULT '0',
  ...
  `hotel_icon`           VARCHAR(255)     DEFAULT NULL
  COMMENT '酒店图片',
  `hotel_image`          VARCHAR(2000)    DEFAULT NULL,
  ...
  `hotel_facility`       VARCHAR(1000)    DEFAULT '',
  `hotel_info`           TEXT,
...
CREATE TABLE IF NOT EXISTS `martin_order` (
  ...
  `order_pay`           VARCHAR(25)      DEFAULT NULL,
