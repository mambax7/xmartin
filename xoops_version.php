...
$modversion = [
    ...
    'name'          => _MI_MARTIN_NAME,
    'description'   => _MI_MARTIN_DESC,
...
$modversion['helpsection'] = [
    ['name' => _MI_MARTIN_OVERVIEW, 'link' => 'page=help'],
    ['name' => _MI_MARTIN_DISCLAIMER, 'link' => 'page=disclaimer'],
    ['name' => _MI_MARTIN_LICENSE, 'link' => 'page=license'],
    ['name' => _MI_MARTIN_SUPPORT, 'link' => 'page=support'],
];
...
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_HOTEL_STAR3 . chr(13) . _MI_MARTIN_HOTEL_STAR4 . chr(13) . _MI_MARTIN_HOTEL_STAR5;
$i++;
...
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_ORDER_TYPE1 . chr(13) . _MI_MARTIN_ORDER_TYPE2;
$i++;
...
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_ORDER_MODE1 . chr(13) . _MI_MARTIN_ORDER_MODE2 . chr(13) . _MI_MARTIN_ORDER_MODE3;
$i++;
...
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_ORDER_STATUS1 . chr(13) . _MI_MARTIN_ORDER_STATUS2 . chr(13) . _MI_MARTIN_ORDER_STATUS3;
$i++;
...
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_PAY_METHOD1 . chr(13) . _MI_MARTIN_PAY_METHOD2 . chr(13) . _MI_MARTIN_PAY_METHOD3;
$i++;
...
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_BED_TYPE1 . chr(13) . _MI_MARTIN_BED_TYPE2 . chr(13) . _MI_MARTIN_BED_TYPE3;
$i++;
...
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_MARTIN_CUSTOMER_NATIONALITY1 . chr(13) . _MI_MARTIN_CUSTOMER_NATIONALITY2 . chr(13) . _MI_MARTIN_CUSTOMER_NATIONALITY3;
$i++;
...
$modversion['config'][$i]['title']       = 'MARTIN_COUPON_TYPES';
$modversion['config'][$i]['description'] = 'MARTIN_COUPON_DESCRIPTION';
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = '';
//------------member-----------//
...
$modversion['config'][$i]['title']       = 'MARTIN_HOTELREVIEW_TYPE';
$modversion['config'][$i]['description'] = 'MARTIN_REVIEW_DESCRIPTION';
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = '';
$i++;
$modversion['config'][$i]['name']        = 'hotel_trip_purpose';
$modversion['config'][$i]['title']       = 'MARTIN_TRIP_PURPOSE';
$modversion['config'][$i]['description'] = 'MARTIN_PURPOSE_DESCRIPTION';
$modversion['config'][$i]['formtype']    = 'textarea';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = '';
...
$modversion['config'][$i]['title'] = 'MARTIN_ONLINEURL_TITLE';
//$modversion['config'][$i]['description'] = 'MARTIN_ONLINEURL_DESCRIPTION';
$modversion['config'][$i]['formtype']  = 'textbox';
$modversion['config'][$i]['valuetype'] = 'text';
...
$modversion['config'][$i]['title']     = 'MARTIN_FRONT_PERPAGE_TITLE';
$modversion['config'][$i]['formtype']  = 'textbox';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default']   = '10';
$i++;
$modversion['config'][$i]['name']      = 'order_send_email';
$modversion['config'][$i]['title']     = 'MARTIN_SEND_EMAIL';
$modversion['config'][$i]['formtype']  = 'textbox';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default']   = '';
